...
def maloka_modelagens_beny():
    """DAG para executar as modelagens do sistema Maloka para o cliente BENY."""
...
# Instanciação da DAG para o cliente BENY
maloka_modelagens_beny_dag = maloka_modelagens_beny()
